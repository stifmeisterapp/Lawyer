...
//  Lawyer
//
//  Created by Aman Kumar on 17/07/20.
...
//        print(urls[urls.count-1] as URL)
        ...
        self.window?.rootViewController = AppStoryboard.launchSB.instantiateInitialViewController()
    ...
    func sceneDidDisconnect(_ scene: UIScene) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "STOP_RECORDING_AND_PLAYING"), object: nil)
