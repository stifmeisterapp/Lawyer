...
public class FAQConfiguration {
  ...
  func defaultValue() {
    ...
    self.questionTextFont = AppFont.Bold.size(AppFontName.OpenSans, size: 16)
    self.answerTextFont = AppFont.Regular.size(AppFontName.OpenSans, size: 12)
    self.titleTextColor = UIColor.black
    self.titleTextFont = AppFont.Bold.size(AppFontName.OpenSans, size: 20)
    self.titleLabelBackgroundColor = UIColor.clear
    self.viewBackgroundColor =  AppColor.tableBGColor
    self.cellBackgroundColor = UIColor.white
    self.separatorColor = AppColor.tableBGColor
  }
}
